...
// Chain creates a simple new funk.Builder from a collection. Each method
...
// LazyChain creates a lazy funk.Builder from a collection. Each method call
...
// LazyChainWith creates a lzy funk.Builder from a generator. Like LazyChain, each
